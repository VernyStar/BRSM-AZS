...
var warning = "В документі знайдено помилки";
var uspih = "Успішна реєстрація";
var inform = "Надана інформація";
var danger = 'Сталася помилка';
var a1 = _('button');
a1.type = 'button';
a1.innerHTML = `
...
const alertUspih = () => {
	...
	alUspih.innerHTML += `
         <div class="info-alert sucess">
            ...
            <div class="info__title">${uspih}</div>
...
const alertDanger = () => {
	...
	alDanger.innerHTML += `
         <div class="info-alert error">
            ...
            <div class="info__title">${danger}</div>
            <div class="info__close">
               <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 20 20" height="20">
                  <path fill="#393a37" d="m15.8333 5.34166-1.175-1.175-4.6583 4.65834-4.65833-4.65834-1.175 1.175 4.65833 4.65834-4.65833 4.6583 1.175 1.175 4.65833-4.6583 4.6583 4.6583 1.175-1.175-4.6583-4.6583z"></path>
               </svg>
...
const alertWarning = () => {
	...
	alWarning.innerHTML += `
      ...
      <div class="info__title">${warning}</div>
      <div class="info__close">
         <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 20 20" height="20">
            <path fill="#393a37" d="m15.8333 5.34166-1.175-1.175-4.6583 4.65834-4.65833-4.65834-1.175 1.175 4.65833 4.65834-4.65833 4.6583 1.175 1.175 4.65833-4.6583 4.6583 4.6583 1.175-1.175-4.6583-4.6583z"></path>
         </svg>
...
const alertInform = () => {
	...
	alInfo.innerHTML += `
      <div class="info-alert">
         ...
         <div class="info__title">${inform}</div>
         <div class="info__close">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 20 20" height="20">
               <path fill="#393a37" d="m15.8333 5.34166-1.175-1.175-4.6583 4.65834-4.65833-4.65834-1.175 1.175 4.65833 4.65834-4.65833 4.6583 1.175 1.175 4.65833-4.6583 4.6583 4.6583 1.175-1.175-4.6583-4.6583z"></path>
            </svg>
